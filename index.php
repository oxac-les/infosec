...
-->
            ...
            <div id="" class="col-md-6">
                ...
                <div class="bs-example">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#sectionA">Policy</a></li>
                        <li><a data-toggle="tab" href="#sectionB">Requirements</a></li>
                        <li><a data-toggle="tab" href="#sectionC">How to Comply</a></li>
                    </ul>
    ...
    <div id="content" class="container">
        ...
        <div id="iwantto" class="view-content row">	
            <div id="" class="col-md-3 iwantto">
                <a href="">
                    <div class="iwanttoWrap">
                        <i class="icon fa fa-lock"></i>                                                             <span>Use Strong Passwords</span></li>
                    </div>
                </a>
            </div>	
            <div id="" class="col-md-3 iwantto">
                <a href="">
                    <div class="iwanttoWrap">
                        <i class="icon fa fa-lock"></i>                                                             <span>Another I Want To</span></li>
                    </div>
                </a>
            </div>		
            <div id="" class="col-md-3 iwantto">
                <a href="">
                    <div class="iwanttoWrap">
                        <i class="icon fa fa-lock"></i>                                                             <span>Another I Want To with a longer title</span></li>
                    </div>
                </a>
            </div>	
            <div id="" class="col-md-3 iwantto">
				...
				<div class="row">
					  <div class="col-md-4">
                        <div class="sitename">Information Security Team 
                            <span class="infosecicon"><img alt="InfoSec Icon" src="img/infosec-logo.png" alt="isip icon"/></span></div>
